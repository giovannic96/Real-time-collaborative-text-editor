...
public:
    ...
    QFrame *frame;
    QPushButton *Grassetto;
    QPushButton *pushButton_2;
    QLabel *DocName;
    QPushButton *pushButton_3;
    QFrame *frame_2;
    QTextEdit *RealTextEdit;
    QMenuBar *menubar;
    QMenu *menuFile;
    ...
    void setupUi(QMainWindow *EditorWindow)
    {
        ...
        Grassetto = new QPushButton(frame);
        Grassetto->setObjectName(QString::fromUtf8("Grassetto"));
        Grassetto->setGeometry(QRect(10, 0, 31, 23));
        QFont font;
...
"text-align: right;"));
        ...
        frame_2->setGeometry(QRect(170, 100, 851, 601));
        frame_2->setStyleSheet(QString::fromUtf8("background-color: white;\n"
"border: 1px solid #808080;"));
        frame_2->setFrameShape(QFrame::StyledPanel);
        frame_2->setFrameShadow(QFrame::Raised);
        frame_2->setMidLineWidth(0);
        RealTextEdit = new QTextEdit(frame_2);
        RealTextEdit->setObjectName(QString::fromUtf8("RealTextEdit"));
        RealTextEdit->setGeometry(QRect(30, 40, 791, 551));
        RealTextEdit->setStyleSheet(QString::fromUtf8("border: transparent;"));
    ...
    void retranslateUi(QMainWindow *EditorWindow)
    {
        ...
        Grassetto->setText(QCoreApplication::translate("EditorWindow", "B", nullptr));
