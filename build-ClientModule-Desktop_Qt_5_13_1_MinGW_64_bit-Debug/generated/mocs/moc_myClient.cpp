...
#include <memory>
#include "../../../ClientModule/myClient.h"
...
QT_MOC_LITERAL(7, 52, 18), // "changeTextUsername"
QT_MOC_LITERAL(8, 71, 4) // "text"

    },
    "myClient\0statusChanged\0\0formResult\0"
    "result\0title\0msg\0changeTextUsername\0"
    "text"
};
...
void myClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->changeTextUsername((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myClient::changeTextUsername)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void myClient::changeTextUsername(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
