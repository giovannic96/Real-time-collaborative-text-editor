...
#include <memory>
#include "../../../ClientModule/userprofile.h"
...
QT_MOC_LITERAL(1, 12, 16), // "closeUserProfile"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 21) // "on_exitButton_clicked"

    },
    "UserProfile\0closeUserProfile\0\0"
...
void UserProfile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->closeUserProfile(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserProfile::closeUserProfile)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void UserProfile::closeUserProfile()
{
