...
#include <memory>
#include "../../../ClientModule/MyQTextEdit.h"
...
QT_MOC_LITERAL(1, 12, 21), // "updateAlignmentButton"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 18), // "removeRemoteCursor"
QT_MOC_LITERAL(4, 54, 11), // "std::string"
QT_MOC_LITERAL(5, 66, 8), // "username"
QT_MOC_LITERAL(6, 75, 18), // "changeRemoteCursor"
QT_MOC_LITERAL(7, 94, 5), // "color"
QT_MOC_LITERAL(8, 100, 3), // "pos"
QT_MOC_LITERAL(9, 104, 18) // "hideHorizontalRect"

    },
    "MyQTextEdit\0updateAlignmentButton\0\0"
    "removeRemoteCursor\0std::string\0username\0"
    "changeRemoteCursor\0color\0pos\0"
    "hideHorizontalRect"
};
...
static const uint qt_meta_data_MyQTextEdit[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void, 0x80000000 | 4, 0x80000000 | 4, QMetaType::Int,    5,    7,    8,
    QMetaType::Void,
...
void MyQTextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateAlignmentButton(); break;
        case 1: _t->removeRemoteCursor((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        case 2: _t->changeRemoteCursor((*reinterpret_cast< std::string(*)>(_a[1])),(*reinterpret_cast< std::string(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 3: _t->hideHorizontalRect(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyQTextEdit::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyQTextEdit::updateAlignmentButton)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyQTextEdit::updateAlignmentButton()
{
