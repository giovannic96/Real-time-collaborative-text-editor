...
SingupWindow::SingupWindow(QWidget *parent) :
    QMainWindow(parent, Qt::FramelessWindowHint | Qt::WindowSystemMenuHint), ui(new Ui::SingupWindow){
    ui->setupUi(this);
...
/*HS************Distruttore della SingupWindow******************************
...
* della finestra
*****************************************************************************/
void SingupWindow::mousePressEvent(QMouseEvent *evt){
...
* sulla finestra
*****************************************************************************/
void SingupWindow::mouseMoveEvent(QMouseEvent *evt){
...
*****************************************************************************/
void SingupWindow::on_exitButton_clicked(){
   QApplication::exit();
}
