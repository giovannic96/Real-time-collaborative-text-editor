...
"}"));
        ...
        label_status->setGeometry(QRect(10, 190, 55, 16));
        pushButton_connect = new QPushButton(centralwidget);
        pushButton_connect->setObjectName(QString::fromUtf8("pushButton_connect"));
        pushButton_connect->setGeometry(QRect(20, 130, 121, 28));
        ...
        pushButton_disconnect->setGeometry(QRect(190, 130, 161, 28));
        textEdit_log = new QTextEdit(centralwidget);
        textEdit_log->setObjectName(QString::fromUtf8("textEdit_log"));
        textEdit_log->setGeometry(QRect(80, 170, 291, 87));
        pushButton_send = new QPushButton(centralwidget);
        pushButton_send->setObjectName(QString::fromUtf8("pushButton_send"));
        pushButton_send->setGeometry(QRect(0, 220, 71, 28));
    ...
    void retranslateUi(QMainWindow *LoginWindow)
    {
        ...
        pushButton_disconnect->setText(QCoreApplication::translate("LoginWindow", "Disconnect from server", nullptr));
        pushButton_send->setText(QCoreApplication::translate("LoginWindow", "send", nullptr));
    } // retranslateUi
