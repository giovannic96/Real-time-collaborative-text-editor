...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    client = new myClient("localhost", 63504);

    setStatus(client->getStatus());

    connect(client, &myClient::hasReadSome, this, &MainWindow::receivedSomething);
    connect(client, &myClient::statusChanged, this, &MainWindow::setStatus);
